...
public class DepthFS {
	...
	String str = "087465132"; // initial state
...
public static void main(String args[]){
    DepthFS e = new DepthFS("325471068", "123456780");              // New Instance of the EightPuzzle
    }
...
void printSolution (String currState){
	if (solution){
		...
		System.out.println("Depth Limit Reached!" + levelDepth.get(currState));
		System.out.println("Node generated: "+ nodes);
		System.out.println("Unique Node generated: "+ unique);
	}
