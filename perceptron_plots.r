...
plot(input_error ,ylab="Error per iteration",xlab="Number of iterations",main="40% Training data, 60% testing Data",pch='.',col='blue')
lines(input_error,col="blue")
par(new = T)
plot(output_error ,xlab=NA,ylab=NA,main=NA,pch='.', col='blue',axes=FALSE)
lines(output_error ,col="red")
legend("topright",c("input_error","output_error"),lty=c(1,1),lwd=c(2.5,2.5),col=c("blue","red") )
